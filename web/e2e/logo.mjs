...
await p.setContent(page("#F3F1EC", "#1B1A17", mark)); await p.screenshot({ path: `${root}/brand/logo-1024-claro.png` });
await p.setContent(page("#141412", "#ECE9E2", mark.replace("#D2461E", "#E8633A"))); await p.screenshot({ path: `${root}/brand/logo-1024-oscuro.png` });
await p.setContent(page("transparent", "#1B1A17", mark)); await p.screenshot({ path: `${root}/brand/logo-1024-transparente.png`, omitBackground: true });
await b.close();
